<?php
/* Template name: Шаблон "Ногтевой сервис" */
get_header(); ?>
            ...
            <div class="visage container-xxl">
                <div class="visage__left wow animate__animated animate__fadeInLeft">
                    <div class="visage__image">
                        <img src="./assets/images/nails.jpg"
                             alt=""/>
                        <h3>Ногтевой <br> сервис</h3>
                    </div>
                    <p>
            ...
            <div class="social container-xxl in-process wow animate__animated animate__fadeInUp">
                ...
                <div class="social__card-wrapper wow animate__animated animate__fadeInTopRight">
                    <div class="social__card scale">
                        <a href="#">
                            <img src="./assets/images/88.jpg" alt="social"/>
                        </a>
                    </div>
                    <div class="social__card scale">
                        <a href="#">
                            <img src="./assets/images/889.jpg" alt="social"/>
                        </a>
                    </div>
                    <div class="social__card scale">
                        <a href="#">
                            <img src="./assets/images/880.jpg" alt="social"/>
                        </a>
                    </div>
                    <div class="social__card scale">
                        <a href="#">
                            <img src="./assets/images/887.jpg" alt="social"/>
                        </a>
                    </div>
                </div>
            ...
            <div id="visage-slider" class="swiper-container social-slider__card-container">
                <div class="swiper-wrapper social-slider__card-wrapper">
                    <div class="swiper-slide visage-slider__card">
                        <a href="#">
                            <img src="./assets/images/photo_2020-09-18_11-24-25%202.jpg" alt="social"/>
                        </a>
                    </div>
                    <div class="swiper-slide visage-slider__card">
                        <a href="#">
                            <img src="./assets/images/photo_2020-09-17_15-58-27%202.jpg" alt="social"/>
                        </a>
                    </div>
                    <div class="swiper-slide visage-slider__card">
                        <a href="#">
                            <img src="./assets/images/photo_2020-09-18_11-26-24%202.jpg" alt="social"/>
                        </a>
                    </div>
                    <div class="swiper-slide visage-slider__card">
                        <a href="#">
                            <img src="./assets/images/vladimir-fedotov-NJAFmCuIx1s-unsplash%20-min.jpg" alt="social"/>
                        </a>
                    </div>
                    <div class="swiper-slide visage-slider__card">
                        <a href="#">
