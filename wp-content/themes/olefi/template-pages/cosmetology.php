<?php
/* Template name: Шаблон "Косметология" */
get_header(); ?>
            ...
            <div class="visage container-xxl">
                <div class="visage__left wow animate__animated animate__fadeInLeft">
                    <div class="visage__image">
                        <img src="<?=get_template_directory_uri(); ?>/assets/images/cosmet.jpg"
                             alt=""/>
                        <h3>Косметология</h3>
                    </div>
                    <p>
                ...
                <div class="visage__right wow animate__animated animate__fadeInRight">
                    ...
                    <div class="visage__right-price">
                        ...
                        <button class="visage__btn" data-bs-toggle="modal" href="#exampleModalToggle" role="button"> Онлайн запись </button>                    </div>
