                    ...
                    <div class="visage__right-tabs hairdressing-services__tabs">
                        <?php if ($page_style == 'woman') : ?>
                            <div class="hairdressing-services__button-wrapper">
                                <a href="<?= get_permalink($man); ?>" class="hairdressing-services__button">
                                    <?= pll_e('Мужчины'); ?>
                                </a>
                            </div>
                            <div class="hairdressing-services__button-wrapper">
                                <a href="<?= get_permalink($kids); ?>" class="hairdressing-services__button">
                                    <?= pll_e('Дети'); ?>
                                </a>
                            </div>
                        <?php elseif ($page_style == 'man') : ?>
                            <div class="hairdressing-services__button-wrapper">
                                <a href="<?= get_permalink($woman); ?>" class="hairdressing-services__button">
                                    <?= pll_e('Девушки'); ?>
                                </a>
                            </div>
                            <div class="hairdressing-services__button-wrapper">
                        ...
                        <div class="visage__right-price">
                                ...
                                <div class="modal-dialog hairdressing-services__modal-dialog">
                                    <div class="modal-content hairdressing-services__modal-content">
                                        ...
                                        <div class="hairdressing-services__modal-body">
                                            <h3><?= pll_e('Линейка длины волос'); ?></h3>
                                                        ...
                                                        <div class="hairdressing-services__type-line">
                                                            <div class="hairdressing-services__type-line-text">
                                                                <div class="hairdressing-services__type-line-text-wrapper">
                                                                    <?= pll_e('1 длина до середины уха'); ?>
                                                                </div>
                                                                <div class="hairdressing-services__item"></div>
                                                            </div>
                                                            <div class="hairdressing-services__type-line-text">
                                                                <div class="hairdressing-services__type-line-text-wrapper">
                                                                    <?= pll_e('2 длина по плечи'); ?>
                                                                </div>
                                                                <div class="hairdressing-services__item"></div>
                                                            </div>
                                                            <div class="hairdressing-services__type-line-text">
                                                                <div class="hairdressing-services__type-line-text-wrapper">
                                                                    <?= pll_e('3 длина ниже плечей до лопаток'); ?>
                                                                </div>
                                                                <div class="hairdressing-services__item"></div>
                                                            </div>
                                                            <div class="hairdressing-services__type-line-text">
                                                                <div class="hairdressing-services__type-line-text-wrapper">
                                                                    <?= pll_e('4 длина ниже лопаток'); ?>
                                                                </div>
                                                                <div class="hairdressing-services__item"></div>
                                                            </div>
                                                            <div class="hairdressing-services__type-line-text">
                                                                <div class="hairdressing-services__type-line-text-wrapper">
                                                                    <?= pll_e('5 длина до пояса'); ?>
                                                                </div>
                                                                <div class="hairdressing-services__item"></div>
                                                            </div>
                                                            <div class="hairdressing-services__type-line-text">
                                                                <div class="hairdressing-services__type-line-text-wrapper">
                                                                    <?= pll_e('1 длина ниже пояса'); ?>
                                                                </div>
                                                                <div class="hairdressing-services__item"></div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                    ...
                                    <div class="accordion visage__accordion service__accordion-top" id="accordionExample">
                                        <?php foreach ($fields['pricelist'] as $key => $item) : ?>
                                            <!--                                        <div class="visage__right-price__list">-->
                                            <!--                                            <div class="hairdressing-services__title-wrapper">-->
                                            <!--                                                <div class="hairdressing-services__title" id="heading--><? //=$key; ?><!--">-->
                                            ...
                                            <!--                                                </div>-->
                                            <!--                                                    <div id="collapse--><? //=$key; ?><!--"-->
                                            <!--                                                         class="accordion-collapse collapse --><?php //if($key == 0) : ?><!-- show --><?php //endif; ?><!-- hairdressing-services__body-wrapper"-->
                                            <!--                                                         aria-labelledby="heading--><? //=$key; ?><!--" data-bs-parent="#accordionExample">-->
                                            <!--                                                        --><?php //foreach($item['usluga'] as $subItem) : ?>
                                            <!--                                                            <div class="hairdressing-services__body">-->
                                            <!--                                                                <p>--><? //=$subItem['title']; ?><!--</p><span>--><? //=$subItem['price']; ?><!--</span>-->
                                            <!--                                                            </div>-->
                                            <!--                                                        --><?php //endforeach; ?>
                                            <!--                                                    </div>-->
                                            <!--                                            </div>-->
                                        ...
                                        <div class="service-price">
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="service__accordion">
                                                    <div class="service__accordion-item" id="headingOne">
                                                        <button class="accordion-button" type="button"
                                                                data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                                                aria-expanded="true" aria-controls="collapseOne">
                                                            СТРИЖКА (мытье+маска+фен)/
                                                        </button>
                                            ...
                                            <div class="service__not-drop-down-wrapper">
                                                ...
                                                <div class="service__not-drop-down">
                                                    <p>Плетение лёгкое (1-2 косички)/</p>
                                                    <span>120-200 грн</span>
                                                </div>
                                                <div class="service__not-drop-down">
                                                    <p>Пирсинг для волос (1-2 косички с украшениями)/</p>
                                                    <span>150-250 грн</span>
                                                </div>
                                                <div class="service__not-drop-down">
                                                    <p>Плетение с каникалоном 1-2 косички/</p>
                                                    <span>200-280 грн</span>
                                                </div>
                                                <div class="service__not-drop-down">
                                                    <p>Сложное плетение/</p>
                                                    <span>300-450 грн</span>
                                                </div>
                                                <div class="service__not-drop-down">
                                                    <p>Укладка лёгкая/</p>
                                                    <span>350-500 грн</span>
                                                </div>
                                                <div class="service__not-drop-down">
                                                    <p>Локоны лёгкие/</p>
                                                    <span>60 грн</span>
                                            ...
                                            <div class="accordion">
                                                <div class="service__accordion">
                                                    <div class="service__accordion-item" id="dropTwoBlockOne">
                                                        <button class="accordion-button" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#collapseTwoBlockOne"
                                                                aria-expanded="true"
                                                                aria-controls="collapseTwoBlockOne">
                                                            ОКРАШИВАНИЕ В 1ТОН/
                                                        </button>
                                                        <span> 200-300 грн</span>
                                                    </div>
                                                    <div id="collapseTwoBlockOne" class="accordion-collapse collapse"
                                                         aria-labelledby="dropTwoBlockOne"
                                                         data-bs-parent="#accordionExample">
                                                        <div class="service__accordion-body">
                                                            <div>
                                                                <div class="service__accordion-body-price">
                            ...
                            <div>
                                <button class="visage__btn" data-bs-toggle="modal" href="#exampleModalToggle"
                                        role="button"> <?= pll_e('Онлайн запись'); ?> </button>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="visage__right-price">
                            ...
                            <div class="tab-content">
                                <div class="visage__title-wrapper">
                                    ...
                                    <?php if ($page_style == 'kids') : ?>
                                        <p class="visage-children__text"><?= pll_e('Дети до 7 лет включительно'); ?></p>
                                    <?php endif; ?>
                                </div>
